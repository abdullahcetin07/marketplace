...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-9">
      ...
      {/* brand shortcuts — an auto-sliding strip the shopper can also drive with the
          prev/next arrows or a swipe (BrandCarousel). Negative vertical margin trims the
          section gap so the strip sits closer to its neighbours. */}
      {topBrands.length > 0 && (
        <div className="-mt-3 -mb-3">
          <BrandCarousel brands={topBrands} />
        </div>
      )}
