...
return [
    ...
    */
    ...
    'errors' => [
        ...
        'offer_not_sellable' => 'One of the items in your basket is no longer available.',
        'insufficient_stock' => 'There is not enough stock for one of the items in your basket.',
        'address_not_found' => 'That address could not be found.',
        'invalid_transition' => 'An order cannot change state that way.',
        'not_cancellable_by_request' => 'This order can no longer be cancelled — it may already be on its way.',
        'cancellation_already_requested' => 'A cancellation request for this order is already awaiting an answer.',
        'cancellation_already_decided' => 'This cancellation request has already been answered.',
        'not_returnable' => 'These items can no longer be returned.',
        'return_window_closed' => 'The return period for this order has ended.',
        'return_already_requested' => 'A return for this order is already in progress.',
        'return_already_decided' => 'This return request has already been answered.',
        'return_not_approved' => 'This return has not been approved yet.',
        'group_not_placeable' => 'This purchase has already been completed or is no longer valid.',
        'missing_tax_rate' => 'One of the items in your basket cannot be priced for tax.',
        'invalid_quantity' => 'You can order between 1 and :max of one item.',
        'cart_full' => 'A basket can hold at most :max different items.',
    ],
